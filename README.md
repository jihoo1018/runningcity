...
| 분류 | 기술 스택 |
|------|-----------|
| **Frontend (Mobile WebView)** | [![My Skills](https://skillicons.dev/icons?i=react,vite,tailwind,ts)](https://skillicons.dev) |
| **Android / Wear OS** | [![My Skills](https://skillicons.dev/icons?i=kotlin,androidstudio)](https://skillicons.dev) |
| **Backend** | [![My Skills](https://skillicons.dev/icons?i=java,spring)](https://skillicons.dev) |
| **DB / Infra** | [![My Skills](https://skillicons.dev/icons?i=postgres,redis,nginx,docker)](https://skillicons.dev) |
| **배포 / DevOps** | [![My Skills](https://skillicons.dev/icons?i=gitlab,docker)](https://skillicons.dev) |
| **Frontend Monitoring** | Firebase |
| **협업** | [![My Skills](https://skillicons.dev/icons?i=gitlab,notion,figma,jira)](https://skillicons.dev) |
